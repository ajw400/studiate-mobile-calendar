...
class CameraScreen extends Component {
  ...
  componentDidMount() {
    FileSystem.makeDirectoryAsync(FileSystem.documentDirectory + 'photosToUpload').catch(e => {
  ...
  takePicture = () => {
    if (this.camera) {
      this.camera.takePictureAsync({ onPictureSaved: this.onPictureTaken, exif: true });
    }
  };

  toggleView = () => this.setState({ showGallery: !this.state.showGallery, currentPhoto: null });

  handleMountError = ({ message }) => console.error(message);

  onPictureTaken = async photo => {
    console.log(photo)
    this.setState({ currentPhoto: photo, showGallery: true })
  }

  renderGallery() {
    return <GalleryScreen
        goBack={this.toggleView.bind(this)}
